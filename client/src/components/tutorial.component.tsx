...
export default class Tutorial extends Component<Props, State> {
  ...
  updatePublished(status: boolean) {
    const data: ITutorialData = {
        ...
        ReenterPassword: this.state.currentTutorial.ReenterPassword,
        Entermobileno: this.state.currentTutorial.Entermobileno,
        Enteremailid: this.state.currentTutorial.Enteremailid,

        //ReenterPassword:this.state.re
        isloggedin: status,
        message: "",
          ...
          <div className="edit-form">
            ...
            <form>
              ...
              <div className="form-group">
                ...
                {currentTutorial.isloggedin ? "Published" : "Pending"}
              </div>
            </form>

            {currentTutorial.isloggedin ? (
              <button
